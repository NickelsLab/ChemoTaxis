...
protected:
  ...
  enum Request
  {
    ...
    RST_STEPS      = 0x24, ///< reset the step counter.
    GET_STEPS      = 0x14, ///< Receive the steps made.
	...
	GET_LINE_SENSOR = 0x20, /// < Read Line Sensors >
	CAL_IR_PROX    = 0x26  /// < calibrate prox sensors >
  };
